...
import edu.handong.csee.isel.bytecodeparser.asm.jasm.TypeAnnotationTargetInfoData.*;

import static edu.handong.csee.isel.bytecodeparser.asm.jasm.JasmTokens.AnnotationType.isInvisibleAnnotationToken;
import static edu.handong.csee.isel.bytecodeparser.asm.jasm.TypeAnnotationTypes.*;
import static edu.handong.csee.isel.bytecodeparser.asm.jasm.JasmTokens.*;
import static edu.handong.csee.isel.bytecodeparser.asm.jasm.ConstantPool.*;
