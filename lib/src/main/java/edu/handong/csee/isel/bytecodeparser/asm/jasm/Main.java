...
import static edu.handong.csee.isel.bytecodeparser.asm.jasm.CFVersion.DEFAULT_MAJOR_VERSION;
import static edu.handong.csee.isel.bytecodeparser.asm.jasm.CFVersion.DEFAULT_MINOR_VERSION;
        ...
        for (int i = 0; i < argv.length; i++) {
            ...
            switch (arg) {
                ...
                case "-nowarn":
                    ...
                    break;
                case "-version":
                    println(org.openjdk.asmtools.util.ProductInfo.FULL_VERSION);
                    break;
                case "-d":
                    if ((i + 1) >= argv.length) {
